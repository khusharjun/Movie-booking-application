...
public class TicketBookingController {
	...
	public ResponseEntity<List<TicketBooking>> findByLocalDate(@PathVariable (name = "from") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) Date from,
...
//	LocalDate date = LocalDate.parse("2021-03-10");
	...
	public ResponseEntity<List<TicketBooking>> viewAllBookings(){
		...
		if(tickets.isEmpty()) {
			throw new BookingNotExistsException("No Booking found in DB : ");
		}
		else {
